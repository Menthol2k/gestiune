<template>
    ...
    <Head title="Modificare client" />

    <Layout :breadcrumbs="['Nomenclatoare', 'Clienti', 'Modificare client']" title="Modificare client">
        <div>
            <div class="mx-auto">
...
export default {
    ...
    data() {
        return {
            form: useForm({
                ...
                office_address: this.client.office_address,
                capital_social: this.client.capital_social,
                euid: this.client.euid,
    ...
    methods: {
        submit() {
            ...
            this.$inertia.put(`/clients/${this.client.id}/update`, this.form, {
                inline: 'default',
                onSuccess: () => {
                    console.log("Clientul a fost modificat cu success!");

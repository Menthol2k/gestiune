...
var non_active_style = ["bg-none", "bg-transparent", "text-green-500", "border-green-500"];
var active_style = ["bg-gradient-to-tl", "from-green-500", "to-violet-500", "bg-green-500", "text-white", "border-transparent"];
